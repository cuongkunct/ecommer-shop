...
function Collection() {
  ...
  //useEffect when changing sortType filter
  useEffect(() => {
    sortFilter();
  }, [sortType]);
    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        >
          FILTER
          <img
            className={`h-3 lg:hidden bg-black ${
        ...
        {/* Categories filter */}
        <div
          className={`border border-gray-300 pl-3 mt-6 ${
            showFilter ? "" : "hidden"
          } sm:block`}
        >
        ...
        >
          <p className="mb-3 text-sm font-medium">CATEGORIES</p>
          <div className="flex flex-col gap-2 text-sm font-sm font-light my-5 text-gray-700">
            <p className="flex gap-2">
              <input
                className="w-3"
                type="checkbox"
